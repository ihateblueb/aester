...
export default {
    ...
    methods: {
        ...
        async loadToots() {
            let initialtoots = await fetch("https://" + this.instanceurl + "/api/v1/timelines/public?local=false", {
                method: "GET",
                headers: {
        ...
        async loadMoreToots(id) {
            let moretoots = await fetch("https://" + this.instanceurl + "/api/v1/timelines/public?local=false&max_id=" + id, {
                method: "GET",
                headers: {
                    "Authorization": "Bearer " + this.token,
                }
