    ...
    <div class="post" v-if="ready && fr_show">
        ...
        <div
            ...
            <div class="notificationTop">
                ...
                <span>Unknown notification type {{ content.type }}. Please report this as a bug on <a
                        href="https://github.com/ihateblueb/aster" target="_blank">the Aster GitHub repo</a>.</span>
            </div>
        </div>
    </div>
</template>
